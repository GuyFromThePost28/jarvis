...
Vader connects to your Apple Calendar, Mail, and Notes. It can browse the web, spawn Claude Code sessions to build entire projects, and plan your day -- all through natural voice conversation.

> "Will do, sir."

<!-- TODO: Add demo GIF or screenshot here -->
<!-- ![Vader Demo](docs/demo.gif) -->

---

## What It Does

- **Voice conversation** -- speak naturally, get spoken responses with a Vader voice
...
- **Audio-reactive orb** -- a Three.js particle visualization that pulses with Vader's voice
...
Click the page once to enable audio, then speak. Vader will respond.
...
# Optional -- your name (Vader will address you personally)
USER_NAME=Tony
...
| TTS | Fish Audio with Vader voice model |
...
4. Vader detects intent -- conversation, action, or build request
...
7. Fish Audio converts the response to speech with the Vader voice
...
### Action System
Vader uses action tags to trigger real system actions:
...
### Memory System
Vader remembers things you tell it using SQLite with FTS5 full-text search. Preferences, decisions, and facts persist across sessions.
...
Inspired by the AI that started it all -- Tony Stark's Vader.

> **Disclaimer:** This is an independent fan project and is not affiliated with, endorsed by, or connected to Marvel Entertainment, The Walt Disney Company, or any related entities. The Vader name and character are property of Marvel Entertainment.

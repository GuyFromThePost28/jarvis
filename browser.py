"""
Vader Browser — Playwright-based web browsing capabilities.
...
log = logging.getLogger("vader.browser")
...
class JarvisBrowser:
    """Playwright-based web browsing for Vader."""
    ...
    async def _ensure_browser(self):
        ...
        # Launch VISIBLE browser so user can watch Vader browse
    ...
    async def screenshot(self, url: str, path: str = None) -> str:
        ...
        try:
            ...
            if not path:
                tmp = tempfile.mktemp(suffix=".png", prefix="vader_screenshot_")
                path = tmp

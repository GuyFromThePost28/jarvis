"""
Vader Proactive Suggestions — Contextual follow-up suggestions after task completion.
...
log = logging.getLogger("vader.suggestions")
...
class Suggestion:
    ...
    text: str  # Voice-friendly suggestion (Vader personality)

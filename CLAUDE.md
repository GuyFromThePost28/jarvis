# Vader — Voice AI Assistant

## Overview
Vader (Vader) is a voice-first AI assistant for macOS. It runs locally on your machine, connecting to your Apple Calendar, Mail, Notes, and can spawn Claude Code sessions for development tasks.
...
10. Click to enable audio, speak to Vader
...
- `USER_NAME` (optional) — Your name for Vader to use
- `CALENDAR_ACCOUNTS` (optional) — Comma-separated calendar emails

## Conventions
- Vader personality: British butler, dry wit, economy of language
